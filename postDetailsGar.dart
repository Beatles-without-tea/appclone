...
class PostDetailsGar extends StatefulWidget {
  PostDetailsGar (this.post);
  final PostGuardian post;

  @override
  State<StatefulWidget> createState() => new _PostDetailsGarState(post);
}

class _PostDetailsGarState extends State<PostDetailsGar> {
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  final PostGuardian post;

  _PostDetailsGarState(this.post);
