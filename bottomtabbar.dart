  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
          ...
          body:_selectedIndex==0? mainBody(_selectedIndex): _selectedIndex==1? showBiz(_selectedIndex): _selectedIndex==2? justPics(_selectedIndex): femailAPI(_selectedIndex),
