...
class showBiz extends StatefulWidget {
  final int botIndex;
  showBiz(this.botIndex);


  @override
  _showBizState createState() => _showBizState();
}

class _showBizState extends State<showBiz> {
  bool _isRequestSent = false;
  List<Post> postList = [];
  //send request function here
  void _sendRequest(botIndex) async {
    String link = "https://content.guardianapis.com/search?order-by=newest&q=celebrities&api-key=6f47359c-bb53-4f0e-88b7-6556f67cb122&show-fields=thumbnail,bodyText";
